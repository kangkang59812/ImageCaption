...
checkpoint = '/home/lkk/code/caption_v1/BEST_checkpoint_coco_5_cap_per_img_5_min_word_freq.pth.tar'  # model checkpoint
word_map_file = '/home/lkk/datasets/coco2014/WORDMAP_coco_5_cap_per_img_5_min_word_freq.json'  # word map, ensure it's the same the data was encoded with and the model was trained with
...
if __name__ == '__main__':
    beam_size = 3
    print("\nBLEU-1~4 score @ beam size of %d is:" % (beam_size), evaluate(beam_size))
