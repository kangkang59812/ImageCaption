...
caption_dir = '/home/lkk/datasets/coco2014/dataset_coco.json'
...
def visualize_att(image_path, seq, alphas, rev_word_map, smooth=True):
    ...
    save_name = image_path.split('/')[-1][:-4]
    ...
    for t in range(len(words)):
        ...
        plt.axis('off')
    plt.savefig('/home/lkk/code/ImageCaption/results/'+save_name+'.jpg')
    plt.close()
    # plt.show()
    # print('')
...
def caption_image_beam_search(encoder, decoder, image_path, word_map, beam_size=3):
    ...
    while True:
        ...
        awe, alpha = decoder.attention(encoder_out, h1, h2)
...
if __name__ == '__main__':
    folder = '/home/lkk/datasets/coco2014/val2014/'
    imgs = []
    ...
    for image_path in tqdm(imgs):
        ...
        seq, alphas = caption_image_beam_search(
            encoder, decoder, image_path, word_map, 3)
        alphas = torch.FloatTensor(alphas)

        # Visualize caption and attention of best sequence
        visualize_att(image_path, seq, alphas, rev_word_map, True)
        plt.close()